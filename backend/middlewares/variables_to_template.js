...
module.exports = (request, response, next) => {
    ...
    if (user !== undefined) {
        ...
        app.locals.avatar =
            user['avatar'] === '' || user['avatar'] === null ? '/uploads/avatar_resized/default.png' : user['avatar'];
        app.locals.is_admin = user['is_admin'] === 1;
        app.locals.credits = user['credits'] ? currency(user['credits']['value']) : 'R$ 0.00';
    } else {
